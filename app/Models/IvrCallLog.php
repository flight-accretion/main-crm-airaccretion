...
class IvrCallLog extends Model
{
    ...
    protected $fillable = ['id','provider_call_id','ivr_call_type_id','call_type_code','dni','cli','normalized_phone','raw_dtmf','agent_name','dial_status','call_start_at','call_end_at','duration_sec','og_duration_sec','voice_url','lead_id','processing_status','processing_message','initial_followup_created_at','raw_payload'];
