...
<div class="grid grid-cols-12 gap-6">
    ...
    <form class="ti-custom-validation view-client-filters" method="GET" action="{{ route('admin.clients.index') }}" id="filter-form" novalidate>
        
        <div class="grid grid-cols-12 gap-x-4 gap-y-3 items-end">
            <div class="xl:col-span-2 lg:col-span-6 md:col-span-6 col-span-12">
                <label for="from-date" class="ti-form-label mb-1">From Service Date</label>
                <input type="date" name="from_date" class="ti-form-input rounded-sm form-control-sm" id="from-date" value="{{ request('from_date') }}">
            </div>
            <div class="xl:col-span-2 lg:col-span-6 md:col-span-6 col-span-12">
                <label for="to-date" class="ti-form-label mb-1">To Service Date</label>
                <input type="date" name="to_date" class="ti-form-input rounded-sm form-control-sm" id="to-date" value="{{ request('to_date') }}">
            </div>
            <div class="xl:col-span-2 lg:col-span-6 md:col-span-6 col-span-12">
                <label for="from-created-date" class="ti-form-label mb-1">From Created Date</label>
                <input type="date" name="from_created_date" class="ti-form-input rounded-sm form-control-sm" id="from-created-date" value="{{ request('from_created_date') }}">
            </div>
            <div class="xl:col-span-2 lg:col-span-6 md:col-span-6 col-span-12">
                <label for="to-created-date" class="ti-form-label mb-1">To Created Date</label>
                <input type="date" name="to_created_date" class="ti-form-input rounded-sm form-control-sm" id="to-created-date" value="{{ request('to_created_date') }}">
            </div>
            <div class="xl:col-span-2 lg:col-span-6 md:col-span-6 col-span-12">
                <label for="name" class="ti-form-label mb-1">Name</label>
                <input type="text" name="name" class="ti-form-input rounded-sm form-control-sm" id="name" value="{{ request('name') }}">
            </div>
            <div class="xl:col-span-2 lg:col-span-6 md:col-span-6 col-span-12">
                <label for="email" class="ti-form-label mb-1">Email</label>
                <input type="text" name="email" class="ti-form-input rounded-sm form-control-sm" id="email" value="{{ request('email') }}">
            </div>
        </div>
        ...
        <div class="grid grid-cols-12 gap-x-4 gap-y-3 items-end mt-4">
            <div class="xl:col-span-2 lg:col-span-6 md:col-span-6 col-span-12">
                ...
                <input type="text" name="phone" class="ti-form-input rounded-sm form-control-sm" id="phone" value="{{ request('phone') }}">
            </div>
            <div class="xl:col-span-2 lg:col-span-6 md:col-span-6 col-span-12">
            ...
            <div class="xl:col-span-2 lg:col-span-6 md:col-span-6 col-span-12">
                ...
                <select name="product_ids" class="js-example-basic-single w-full form-control-sm" id="product-filter">
                    <option value="">Select Product</option>
                    @foreach ($products as $product)
                        <option value="{{ $product->id }}" {{ request('product_ids') == $product->id ? 'selected' : '' }}>{{ $product->product }}</option>
                    @endforeach
                </select>
            </div>
            <div class="xl:col-span-2 lg:col-span-6 md:col-span-6 col-span-12">
                <div class="flex gap-2">
                    <button type="submit" class="ti-btn bg-primary text-white !py-1 !px-4 hover:bg-primary-hover">
                        Apply
                    </button>
            ...
            <div class="box-header flex justify-between items-center">
                ...
                <div class="flex gap-3 items-center">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <select id="per-page-select" class="ti-form-select rounded-sm form-control-sm"
                            style="width: 80px;">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-defaultborder">
                                ...
                                <td class="text-center">
                                    ...
                                    {{ $latestFollowups[$enquiry->id]->next_followup_date->format('d-m-Y H:i') }}
                                    @else
                                    N/A
                                    @endif
                                </td>
                                ...
                                <td>
                                    {{-- <div class="followup-history grid gap-2">
                                        ...
                                        <div class="grid gap-2">
                                            <p class="text-sm text-gray-700 "><strong>Note:</strong> {{
                                                $followup->followup_note }}</p>
                                            <p class="text-sm text-gray-700">
                                                <strong>Status:</strong>
                                                <span class="badge bg-primary/10 text-primary">
                                                    {{ $followup->status == 1 ? 'Pending' : ($followup->status == 2 ?
                                                    'Completed' : 'Skipped') }}
                                                </span>
                                            </p>
                                            <p class="text-sm text-gray-700">
                                    ...
                                    <div class="followup-history table-responsive">
                                        <table class="table display responsive nowrap" width="100%">
                                            ...
                                            <tbody class="table-group-divider dark:border-defaultborder/10">
                                                ...
                                                @empty
                                                <tr>
                                                    <td colspan="4" class="text-sm text-gray-700 text-center">No
                                                        follow-up
                                                        history</td>
                                                </tr>
                                                @endforelse
                                ...
                                <td>
                                    <div class="hstack flex gap-3 text-[.9375rem]" style="align-items:flex-start;">
                                        ...
                                        <a aria-label="anchor"
                                            ...
                                            title="Generate Voucher"><i class="ri-file-text-line"></i>
                                        </a>
                                        ...
                                        <div style="position:relative; display:inline-flex; flex-direction:column; align-items:center;">
                                            ...
                                            <span style="font-size:8px; color:#f59e0b; white-space:nowrap; line-height:1.2; margin-top:2px; text-align:center;">
                                        Add<br>followup<br>from here
                                            </span>
                                        </div>
                                        ...
                                        @if (in_array(optional(auth()->user()->userType)->user_type,
                ...
                <div class="xl:col-span-12 col-span-12">
                    <form id="confirm-followup-form">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="notes" id="confirm-notes" rows="3"
                                class="ti-form-input form-control form-control-sm" required maxlength="1000"
...
<div id="cancel-followup-modal"
    ...
    <div class="alert custom-alert1 alert-primary !bg-white dark:!bg-bodybg w-[90%] max-w-md">
        ...
        <div class="text-center px-[3rem] pb-0">
            ...
            <div class="">
                <button type="button" class="ti-btn ti-btn-outline-secondary px-4 py-1" id="decline-cancel">No</button>
                <button type="button" class="ti-btn bg-primary text-white px-4 py-1" id="proceed-to-cancel">Yes</button>
            </div>
        </div>
    </div>
</div>
...
<!-- Cancel Notes Modal -->
<div id="cancel-notes-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    <div class="alert custom-alert1 alert-primary !bg-white dark:!bg-bodybg w-[90%] max-w-md">
...
<div id="custom-delete-alert" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white p-6 rounded-lg shadow-lg w-[90%] max-w-md text-center">
        ...
        <div class="flex justify-center gap-4">
            <button type="button" class="ti-btn ti-btn-outline-danger px-4 py-1" id="decline-delete">Decline</button>
...
<div id="toggle-status-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white p-6 rounded-lg shadow-lg w-[90%] max-w-md text-center">
        ...
        <div class="flex justify-center gap-4">
            <button type="button" class="ti-btn ti-btn-outline-secondary px-4 py-1" id="cancel-toggle">Cancel</button>
    ...
    $(document).ready(function() {
            ...
            $('#global-search').on('keyup', function() {
                ...
                searchTimeout = setTimeout(function() {
                    // Get current URL and add/update search parameter
                    ...
                    // Redirect to new URL with search parameter
...
<script>
    window.addEventListener('DOMContentLoaded', () => {
        ...
        function clearFilters() {
            $('#filter-form')[0].reset();
            $('#global-search').val(''); // Clear global search as well
