                                ...
                                <div class="box-body">
                                    <div class="grid grid-cols-12 sm:gap-6">
                                        ...
                                        <div class="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                                            ...
                                            <input type="number" name="service_amount" class="my-auto ti-form-input rounded-sm form-control-sm" placeholder="Service Amount" value="{{ old('service_amount') }}" required>
