...
@section('content')
            <!-- Page Header -->
                <div class="block justify-between page-header md:flex">
                    <div>
                        <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.125rem] font-semibold">Add Services</h3>
                    </div>
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-12">
                        <form class="ti-custom-validation" action="{{ route('admin.services.store') }}" method="POST" id="serviceForm" novalidate>
                            @csrf
                            <div class="box">
                                <div class="box-body">
                                    <div class="grid grid-cols-12 sm:gap-6">
                                        <div class="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                                            ...
                                            <input type="text" name="service" class="my-auto ti-form-input rounded-sm form-control-sm" placeholder="Service Name" value="{{ old('service') }}" required>
                                            @error('service')
                                        ...
                                        <div class="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                                            ...
                                            <input type="number" name="service_amount" id="service_amount_input" class="my-auto ti-form-input rounded-sm form-control-sm" placeholder="Service Amount" value="{{ old('service_amount') }}" required>
                                        ...
                                        <div class="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                                            ...
                                            <input type="number" step="0.01" min="0" max="100" name="fees_percent" id="fees_percent_input" class="my-auto ti-form-input rounded-sm form-control-sm" placeholder="Fees %" value="{{ old('fees_percent', 0) }}">
                                            @error('fees_percent')
                                                <span class="text-red-500 text-xs">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                                            ...
                                            <input type="text" id="amount_after_fees_preview" class="my-auto ti-form-input rounded-sm form-control-sm" value="0.00" readonly>
                                        </div>
                                        <div class="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                                        ...
                                        <div class="xl:col-span-6 lg:col-span-12 md:col-span-6 sm:col-span-12 col-span-12">
                                            <label class="ti-form-label dark:text-defaulttextcolor/70 mb-0">Description</label>
                                            <textarea class="ti-form-input w-full rounded-sm form-control-sm" name="description" rows="1">{{ old('description') }}</textarea>
                                            @error('description')
                                                <span class="text-red-500 text-xs">{{ $message }}</span>
                                            @enderror
                                        </div>                             
                                    ...
                                    <div class="my-5">
                                        ...
                                        <textarea id="termsEditor" name="terms_and_conditions" class="hidden">{!! old('terms_and_conditions', '<ol><li>Write text select and edit with multiple options.</li><li>This is quill snow editor.</li><li>Easy to customize and flexible.</li></ol>') !!}</textarea>
                                        <div id="editor"></div>
                                    ...
                                    @include('admin.pages.services.partials.extra-service-picker', [
                                        ...
                                        'selectedExtraServiceIds' => old('extra_service_ids', []),
                                    ])
                                </div>
                                <div class="box-footer">
                                    <button type="submit" class="ti-btn ti-btn-primary-full ti-custom-validate-btn">Save Service</button>
                                </div>
                            </div>
                            {{-- <div class="box">
                                ...
                                <div class="box-body">
                                    <div id="repeatableFieldsContainer">
                                        @php
                                            $extraServices = old('extra_services', [['id' => '', 'name' => '', 'amount' => '', 'description' => '']]);
                                        @endphp
                                        @foreach($extraServices as $index => $extra)
                                            <div class="repeatable-row grid grid-cols-12 gap-x-4 gap-y-2 items-center mt-5">
                                                <div class="sm:col-span-3 col-span-12">
                                                    <label class="ti-form-label mb-0">Service Name *</label>
                                                ...
                                                <div class="sm:col-span-3 col-span-12 extra-service-name-container hidden">
                                                    <label class="ti-form-label mb-0">Service Name (New)</label>
                                                    <input type="text"
                                                        name="extra_services[{{ $index }}][name]"
                                                        class="ti-form-input extra-service-name rounded-sm form-control-sm hidden"
                                                        placeholder="Service Name"
                                                        value="{{ old("extra_services.$index.name", $extra['name'] ?? '') }}"
                                                        {{ isset($extra['id']) ? 'readonly' : '' }}>
                                                ...
                                                <div class="sm:col-span-2 col-span-12 extra-service-amount-container hidden">
                                                    ...
                                                    <input type="number"
                                                        ...
                                                        value="{{ old("extra_services.$index.amount", $extra['amount']) }}"
                                                        min="0" required>
                                                ...
                                                <div class="sm:col-span-2 col-span-12 extra-service-description-container hidden">
...
<script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                // Optional: Validate at least one extra service exists
                // const extraServices = document.querySelectorAll('[name^="extra_services["]');
                // if (extraServices.length === 0) {
                //     e.preventDefault();
                //     alert('Please add at least one extra service');
                //     return false;
                // }
            });
        ...
        $(document).ready(function() {
            $('#product_id').select2({
                ...
                allowClear: true,
                width: '100%',
                minimumInputLength: 1 // Enable search after typing 1 character
            });
