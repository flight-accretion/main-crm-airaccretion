                    ...
                    <div class="box">
                        <form action="{{ route('admin.products.store') }}" method="POST">
                            ...
                            <div class="box-body">
                                <div class="grid grid-cols-12 sm:gap-6">
                                    ...
                                    <div class="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                                        ...
                                        <input type="text" name="product" class="ti-form-input rounded-sm form-control-sm" id="product" required>
                                        @error('product')
                                    ...
                                    <div class="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                                        ...
                                        <input class="form-check-input" type="checkbox" value="1" id="is_airambulance" name="is_airambulance" {{ old('is_airambulance', 0) ? 'checked' : '' }}>
                                    ...
                                    <div class="xl:col-span-12 col-span-12 mt-4">
                                        ...
                                        <textarea name="booking_email_note" id="booking_email_note" class="ti-form-input rounded-sm form-control-sm" rows="3">{{ old('booking_email_note') }}</textarea>
                            ...
                            <div class="box-footer">
                                <button type="submit" class="ti-btn ti-btn-primary-full ti-custom-validate-btn">Save Product</button>
                            </div>
                        </form>
                    </div>
                </div>
