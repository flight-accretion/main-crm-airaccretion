(function () {
  ...
  if (myHeaderShortcut && typeof SimpleBar !== "undefined") {
    ...
    for (const [theme, config] of nanoThemes) {
      ...
      button.addEventListener("click", () => {
        ...
        nanoPickr.on("changestop", (source, instance) => {
          ...
          const primaryRGB = `${Math.floor(color[0])} ${Math.floor(color[1])} ${Math.floor(color[2])}`;
          const primaryRGBComma = `${Math.floor(color[0])}, ${Math.floor(color[1])}, ${Math.floor(color[2])}`;
    ...
    for (const [theme, config] of nanoThemes) {
      ...
      button.addEventListener("click", () => {
        ...
        nanoPickr1.on("changestop", (source, instance) => {
          let color = instance.getColor().toRGBA();
          let html = document.querySelector("html");
          const bodyBgRGB = `${Math.floor(color[0] + 14)} ${Math.floor(color[1] + 14)} ${Math.floor(color[2] + 14)}`;
          const darkBgRGB = `${Math.floor(color[0])} ${Math.floor(color[1])} ${Math.floor(color[2])}`;
          const lightRGB = `${Math.floor(color[0] + 5)} ${Math.floor(color[1] + 5)} ${Math.floor(color[2] + 5)}`;
          html.style.setProperty(
            "--body-bg",
            bodyBgRGB
          );
  ...
  headerbtn2.forEach((button, index) => {
    button.addEventListener("click", (e) => {
      ...
      if (document.getElementById("allCartsContainer")) {
        const cartCount = document.getElementById("allCartsContainer").children.length;
        if (document.getElementById("cart-data")) {
          document.getElementById("cart-data").innerText = `${cartCount} Items`;
        }
        if (document.getElementById("cart-data2")) {
          document.getElementById("cart-data2").innerText = cartCount;
        }
      }
      if (document.getElementById("allNotifyContainer")) {
        const notifyCount = document.getElementById("allNotifyContainer").children.length;
        if (document.getElementById("notify-data")) {
          document.getElementById("notify-data").innerText = notifyCount;
        }
      }
  ...
  headerbtn.forEach((button) => {
    button.addEventListener("click", (e) => {
      ...
      const dropdownCartCount = document.querySelectorAll(".dropdown-item-close").length;
      if (document.getElementById("cart-data")) {
        document.getElementById("cart-data").innerText = `${dropdownCartCount} Items`;
      }
      if (document.getElementById("cart-icon-badge")) {
        document.getElementById("cart-icon-badge").innerText = dropdownCartCount;
      }
      console.log(
  ...
  headerbtn1.forEach((button) => {
    button.addEventListener("click", (e) => {
      ...
      const dropdownNotificationCount = document.querySelectorAll(".dropdown-item-close1").length;
      if (document.getElementById("notifiation-data")) {
        document.getElementById("notifiation-data").innerText = `${dropdownNotificationCount} Unread`;
      }
      if (document.getElementById("notification-icon-badge")) {
        document.getElementById("notification-icon-badge").innerText = dropdownNotificationCount;
      }
