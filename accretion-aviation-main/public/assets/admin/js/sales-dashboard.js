...
if (!document.querySelector("#salesOverview")) {
    window.salesOverview = window.saleValue = function () {};
} else {
var myElement1 = document.getElementById('latest-timeline');
if (myElement1 && typeof SimpleBar !== 'undefined') {
