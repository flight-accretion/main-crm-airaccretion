if (!document.querySelector("#crm-main")) {
    window.crmtotalCustomers = window.revenueAnalytics = window.crmProfitsearned = window.leads = function () {};
} else {
...
window.crmtotalCustomers = crmtotalCustomers;
window.revenueAnalytics = revenueAnalytics;
window.crmProfitsearned = crmProfitsearned;
window.leads = leads;
/* Leads By Source Chart */
}
